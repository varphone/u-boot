...
setenv my_env_ver   "Info: Linux-3.14.52  MYIMXA9  eMMC"
...
'setenv bootargs console=${console},${baudrate} ${smp} ${bootargs_cma} root=${mmcroot} rootwait rw ${bootargs_disp}; fi;'
setenv bootargs_net 'if run set_disp; then '\
'setenv bootargs console=${console},${baudrate} ${smp} ${bootargs_cma} root=/dev/nfs ip=dhcp nfsroot=${serverip}:${nfsroot},v3,tcp; fi;'
