...
/*
 * board/vaxpl/qx1/firmware/timing.c
 *
 * Copyright (C) 2021 Vaxpl, Inc. All rights reserved.
 *
...
ddr_set_t __ddr_setting[] = {
{
	...
	.dram_data_drv_ohm		= 40,//lpddr4 sdram only 240/1-6
	.dram_data_odt_ohm		= 120,
	.dram_ac_odt_ohm		= 120,
	.lpddr4_dram_vout_voltage_1_3_2_5_setting = 1,//1, 1/3 vddq, 0 2/5 vddq
	...
	.vref_dram_permil		= 0,
	//.vref_reverse			= 0,
	.ac_trace_delay			= {0,0,0,0,0,0,0,0},
	.ac_pinmux				= {0,0},
	.ddr_dmc_remap			= {
