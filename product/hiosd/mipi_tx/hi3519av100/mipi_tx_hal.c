...
int hal_phy_getphy_statusphy_stopstateXlane(unsigned int x, unsigned int * phy_stopstateXlane)
{
    ...
    phy_status.u32 = mipi_tx_regs_va->PHY_STATUS.u32;
    switch(x)
    {
        // 0lane
        case 0:
            *phy_stopstateXlane = phy_status.bits.phy_stopstate0lane;
            break;
        // 1lane
        case 1:
            *phy_stopstateXlane = phy_status.bits.phy_stopstate1lane;
            break;
        // 2lane
        case 2:
            *phy_stopstateXlane = phy_status.bits.phy_stopstate2lane;
            break;
        // 3lane
        case 3:
            *phy_stopstateXlane = phy_status.bits.phy_stopstate3lane;
            break;
        default:
            // do nothing.
            break;
...
int hal_phy_getphy_statusphy_ulpsactivenotXlane(unsigned int x, unsigned int * phy_ulpsactivenotXlane)
{
    ...
    switch(x)
    {
        // 0lane
        case 0:
            *phy_ulpsactivenotXlane = phy_status.bits.phy_ulpsactivenot0lane;
            break;
        // 1lane
        case 1:
            *phy_ulpsactivenotXlane = phy_status.bits.phy_ulpsactivenot1lane;
            break;
        // 2lane
        case 2:
            *phy_ulpsactivenotXlane = phy_status.bits.phy_ulpsactivenot2lane;
            break;
        // 3lane
        case 3:
            *phy_ulpsactivenotXlane = phy_status.bits.phy_ulpsactivenot3lane;
            break;
        default:
            // do nothing.
            break;
