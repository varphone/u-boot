                  ...
                  HI_VOID *buffer, HI_U32 size)
{
    ...
    ptr[0] = (((HI_U8)frame->coding_type & 0xf) << 4) | (frame->channels & 0x7);
    ptr[1] = (((HI_U8)frame->sample_frequency & 0x7) << 2) |
             ((HI_U8)frame->sample_size & 0x3);
    ptr[2] = (HI_U8)frame->coding_type_ext & 0x1f;
    ptr[3] = frame->channel_allocation;
    ptr[4] = (frame->level_shift_value & 0xf) << 3;
    ptr[4] |= (HI_U8)frame->lfe_playback_level & 0x3;
