...
HI_S32 HAL_HDMI_CtrlInit(HDMI_DEVICE_ID_E enHdmi, HDMI_HAL_INIT_S *pstHalInit)
{
    ...
    if (!pstCtrlInfo->bInit)
    {
        ...
        (HI_VOID)HAL_HDMI_MachStart(pstCtrlInfo->u32MachId);
...
HI_S32 HAL_HDMI_CtrlDeinit(HDMI_DEVICE_ID_E enHdmi)
{
    ...
    HAL_HDMI_MachUnRegister(pstCtrlInfo->u32MachId);
    HDMI_TX_S_audio_path_reg_REGS_TYPE_DeInit();
/* This functions will not be used at BVT */
#ifndef CONFIG_HDMI_BVT_SDK
    HDMI_TX_S_mcu_cpu_reg_REGS_TYPE_DeInit();
#endif
#endif
