...
HI_S32 SYS_HAL_VouHdmiClkEn(HI_BOOL pbHdmiClkEn)
{
    ...
    HI_RegSetBit(u32Tmp, 18, IO_ADDRESS(VOU_CRG_PERCTL_ADDR));
...
HI_S32 SYS_HAL_VouMipiClkEn(HI_BOOL pbMipiClkEn)
{
    ...
    HI_RegSetBit(u32Tmp, 19, IO_ADDRESS(VOU_CRG_PERCTL_ADDR));
...
HI_S32 SYS_HAL_VouHd0DivMode(HI_U32 u32Hd0DivMod)
{
    ...
    HI_RegWrite32(u32Hd0DivMod << 12, 0x3 << 12, IO_ADDRESS(VOU_CRG_PERCTL_ADDR));
...
{
    HI_RegWrite32(u32ClkSel << 14, 0x1 << 14, IO_ADDRESS(VOU_CRG_PERCTL_ADDR));
...
HI_S32 SYS_HAL_VouHdOutPctrl(HI_BOOL pbClkReverse)
{
    ...
    HI_RegSetBit(u32Tmp, 20, IO_ADDRESS(VOU_CRG_PERCTL_ADDR));
...
{
    HI_RegWrite32(u32ClkSel << 21, 0xf << 21, IO_ADDRESS(VOU_CRG_PERCTL_ADDR));
...
{
    HI_RegWrite32(u32HdmiClkDiv << 25, 0x1f << 25, IO_ADDRESS(VOU_CRG_PERCTL_ADDR));
...
{
    HI_RegWrite32(u32DataMode << 8, 0x7 << 26, IO_ADDRESS(MISC_CTL18_ADDR));
