...
hi_s32 sys_hal_sel_vo_lcd8bit_pin_conifg(hi_void)
{
    hi_reg_write32(0x4f2, 0xffffffff, IO_ADDRESS(IO_CONFIG_LCD_CLK  ));
    hi_reg_write32(0x4f2, 0xffffffff, IO_ADDRESS(IO_CONFIG_LCD_DE   ));
    hi_reg_write32(0x4f2, 0xffffffff, IO_ADDRESS(IO_CONFIG_LCD_HSYNC));
    hi_reg_write32(0x4f2, 0xffffffff, IO_ADDRESS(IO_CONFIG_LCD_VSYNC));
    hi_reg_write32(0x4f2, 0xffffffff, IO_ADDRESS(IO_CONFIG_LCD_DATA0));
    hi_reg_write32(0x4f2, 0xffffffff, IO_ADDRESS(IO_CONFIG_LCD_DATA1));
    hi_reg_write32(0x4f2, 0xffffffff, IO_ADDRESS(IO_CONFIG_LCD_DATA2));
    hi_reg_write32(0x4f2, 0xffffffff, IO_ADDRESS(IO_CONFIG_LCD_DATA3));
    hi_reg_write32(0x4f2, 0xffffffff, IO_ADDRESS(IO_CONFIG_LCD_DATA4));
    hi_reg_write32(0x4f2, 0xffffffff, IO_ADDRESS(IO_CONFIG_LCD_DATA5));
    hi_reg_write32(0x4f2, 0xffffffff, IO_ADDRESS(IO_CONFIG_LCD_DATA6));
    hi_reg_write32(0x4f2, 0xffffffff, IO_ADDRESS(IO_CONFIG_LCD_DATA7));

    printf("lcd8bit pin config end.\n");
    return 0;
}
...
hi_s32 sys_hal_vo_lcd_clk_en(hi_bool clk_en)
{
    ...
    hi_reg_set_bit(tmp, 27, IO_ADDRESS(CRG_PERCTL72_ADDR));
...
hi_s32 sys_hal_vo_hd_out_pctrl(hi_bool clk_reverse)
{
    ...
    hi_reg_set_bit(tmp, 29, IO_ADDRESS(CRG_PERCTL73_ADDR));
...
static hi_void hal_disp_set_bt_ctrl(hal_disp_intf intf, hi_u32 *ctrl_info)
{
...
static hi_void hal_disp_set_lcd_ctrl(hal_disp_intf intf, hi_u32 *ctrl_info)
{
    U_INTF_LCD_CTRL INTF_LCD_CTRL;
...
static hi_void hal_disp_set_hdmi_ctrl(hal_disp_intf intf, hi_u32 *ctrl_info)
{
...
static hi_void hal_layer_csc_set_video0_dc_coef(hal_disp_layer layer, csc_coef *csc_coef)
{
...
static hi_void hal_layer_csc_set_video1_dc_coef(hal_disp_layer layer, csc_coef *csc_coef)
{
...
static hi_void hal_layer_csc_set_video_dc_coef(hal_disp_layer layer, csc_coef *csc_dc_coef)
{
...
static hi_void hal_layer_csc_set_gfx_dc_coef(hal_disp_layer layer, csc_coef *csc_coef)
{
...
hi_void hal_layer_csc_set_dc_coef(hal_disp_layer layer, csc_coef *csc_dc_coef)
{
...
static void hal_layer_csc_set_video_param(hal_disp_layer layer, csc_coef *csc_coef)
{
...
static hi_void hal_layer_csc_set_gfx_param(hal_disp_layer layer, csc_coef *coef_param)
{
    return;
}

hi_void hal_layer_csc_set_param(hal_disp_layer layer, csc_coef *coef_param)
{
    if ((layer >= LAYER_VHD_START) && (layer <= LAYER_VHD_END)) {
...
static hi_void hal_layer_csc_set_video_coef0x(hal_disp_layer layer, csc_coef *csc_coef)
{
...
static hi_void hal_layer_csc_set_video_coef1x(hal_disp_layer layer, csc_coef *csc_coef)
{
...
static hi_void hal_layer_csc_set_video_coef2x(hal_disp_layer layer, csc_coef *csc_coef)
{
...
static hi_void hal_layer_csc_set_gfx_coef0x(hal_disp_layer layer, csc_coef *csc_coef)
{
...
static hi_void hal_layer_csc_set_gfx_coef1x(hal_disp_layer layer, csc_coef *csc_coef)
{
...
static hi_void hal_layer_csc_set_gfx_coef2x(hal_disp_layer layer, csc_coef *csc_coef)
{
...
hi_void hal_layer_csc_set_coef(hal_disp_layer layer, csc_coef *csc_coef)
{
    if ((layer >= LAYER_VHD_START) && (layer <= LAYER_VHD_END)) {
