...
int spacc_symc_gettag(unsigned int chn_num, unsigned char *tag)
{
    ...
    flush_cache (CIPHER_ALIGN((HI_SIZE_T)info->entry_symc_out, 0x20), ALIGN(SPACC_PAGE_SIZE, CIPHER_DMA_MINALIGN));
                         ...
                         unsigned int ctrl)
{
    ...
    flush_cache (CIPHER_ALIGN(buf_phy, 0x20), ALIGN(buf_size, CIPHER_DMA_MINALIGN));
...
int spacc_symc_start(unsigned int chn_num, unsigned int decrypt, unsigned int iv_set_flag)
{
    ...
    flush_cache (CIPHER_ALIGN((HI_SIZE_T)info->entry_symc_in, 0x20), ALIGN(SPACC_PAGE_SIZE, CIPHER_DMA_MINALIGN));
    flush_cache (CIPHER_ALIGN((HI_SIZE_T)info->entry_symc_out, 0x20), ALIGN(SPACC_PAGE_SIZE, CIPHER_DMA_MINALIGN));
                                ...
                                unsigned int *state)
{
    ...
    flush_cache (CIPHER_ALIGN((HI_SIZE_T)info->entry_digest_in, 0x20), ALIGN(SPACC_PAGE_SIZE, CIPHER_DMA_MINALIGN));
